...
public class EnemyConst {
	...
	public static final int attrange[] = { 1200, 150, 150, 300, 50, 300 };
	public static final int alrtrange[] = { 1560, 600, 600, 650, 200, 2000 };
	...
	public static final int specseq[] = { 0, 0, 0, 0, 0, 2 };
	...
	public static final float Velv[] = { 0, 120, 11, 20, 100, 400 };// movement vel

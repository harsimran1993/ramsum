...
public class Assetloader {
	...
	public static void init()
	{
		...
		//specialeffects
		specilaeff=new TextureRegion[3][];
		specilaeff[0]= new TextureRegion[4];//blastground
		specilaeff[1]= new TextureRegion[4];//flight
	...
	public static void load() {
		...
		UI= new TextureAtlas(Gdx.files.internal("ui/ui.atlas"),true);
	     ...
	     manager.load("blast.png",Texture.class,param);
	     ...
	     blastT=manager.get("blast.png", Texture.class);
		...
		blast[0]=new TextureRegion(blastT, 2, 2, 128, 128);
		blast[0].flip(false, true);
		blast[1]=new TextureRegion(blastT, 260, 260, 128, 128);
		blast[1].flip(false, true);
		blast[2]=new TextureRegion(blastT, 132, 2, 128, 128);
		blast[2].flip(false, true);
		blast[3]=new TextureRegion(blastT, 2, 132, 256, 256);
		blast[3].flip(false, true);
		...
		/*//enemy-2-idle
		Atlas = new TextureAtlas("henchidle.atlas");
		enemydie[2]=new TextureRegion[9];
		enemydie[2][0]=Atlas.findRegion("hencher_stance0005");
		enemydie[2][1]=Atlas.findRegion("hencher_stance0008");
		enemydie[2][2]=Atlas.findRegion("hencher_stance0010");
		enemydie[2][3]=Atlas.findRegion("hencher_stance0012");
		enemydie[2][4]=Atlas.findRegion("hencher_stance0015");
		enemydie[2][5]=Atlas.findRegion("hencher_stance0019");
		enemydie[2][6]=Atlas.findRegion("hencher_stance0022");
		enemydie[2][7]=Atlas.findRegion("hencher_stance0024");
		enemydie[2][8]=Atlas.findRegion("hencher_stance0026");*/
		...
		specilaeff[1][0] = new TextureRegion(specialeffT, 207, 568, 212, 160);
		specilaeff[1][1] = new TextureRegion(specialeffT, 207, 406, 212, 160);
		specilaeff[1][2] = new TextureRegion(specialeffT, 2, 164, 212, 160);
		specilaeff[1][3] = new TextureRegion(specialeffT, 2, 2, 212, 160);
		//specilaeff[1][4] = new TextureRegion(specialeffT, 828, 770, 212, 160);
		//specilaeff[1][5] = new TextureRegion(specialeffT, 421, 592, 212, 160);
		//specilaeff[1][6] = new TextureRegion(specialeffT, 421, 430, 212, 160);
		
		specilaeff[2][0] = new TextureRegion(specialeffT, 412, 754, 206, 176);
		specilaeff[2][1] = new TextureRegion(specialeffT, 620, 754, 206, 176);

		specialeffA[1]= new Animation(0.06f, specilaeff[1]);
		specialeffA[1].setPlayMode(Animation.PlayMode.LOOP);
		specialeffA[2]= new Animation(0.02f, specilaeff[2]);
		...
		blastA= new Animation(0.15f, blast);
		blastA.setPlayMode(Animation.PlayMode.REVERSED);
